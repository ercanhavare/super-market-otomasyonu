...
<!--/////////////////////////////////////////////Header son////////////////////////////////////////////////////////////-->
 ...
 if(isset($_GET["session"])){
	 ...
	 $satir = @mysql_fetch_array($sonuc);//verileri cek...
 			...
 			}elseif($_POST["kayit"]=="guncelle"){//guncelleme işlemi yap
					require_once("db/dbconnect.php");
			$tablo = "uyeler";
				$sorgu = @sprintf("UPDATE $tablo SET ad='%s',soyad='%s',email='%s',
									telefon='%s',cinsiyet='%s',d_tarih='%s',adres='%s' WHERE kullanici_adi='%s'",
											$_POST["ad"],$_POST["soyad"],$_POST["email"],$_POST["telefon"],
													$_POST["cinsiyet"],$_POST["d_tarih"],$_POST["adres"],$_POST["id"]);
...
<form name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
  <table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="50">&nbsp;</td>
      <td><input type="submit"  value="Hesabı Güncelle" style="color:rgba(0,153,102,1);background-color:rgba(204,204,204,1);"></td>
      <td>
